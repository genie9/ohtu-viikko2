...
scenario "creation fails with correct username and too short password", {
    given 'command new user is selected', {
       userDao = new InMemoryUserDao()
       auth = new AuthenticationService(userDao)
       io = new StubIO("new", "eero", "sala1", "login", "eero", "sala1nen") 
       app = new App(io, auth)
    }
...
scenario "creation fails with correct username and pasword consisting of letters", {
    given 'command new user is selected', {
       userDao = new InMemoryUserDao()
       auth = new AuthenticationService(userDao)
       io = new StubIO("new", "eero", "salainen", "login", "eero", "sala1nen") 
       app = new App(io, auth)
    }
...
scenario "creation fails with too short username and valid pasword", {
       ...
       userDao = new InMemoryUserDao()
       auth = new AuthenticationService(userDao)
       io = new StubIO("new", "ee", "sala1nen", "login", "eero", "sala1nen") 
       app = new App(io, auth)
	}
...
scenario "creation fails with already taken username and valid pasword", {
    given 'command new user is selected', {
       userDao = new InMemoryUserDao()
       auth = new AuthenticationService(userDao)
       io = new StubIO("new", "pekka", "sala1nen", "login", "eero", "sala1nen") 
       app = new App(io, auth)
	}
